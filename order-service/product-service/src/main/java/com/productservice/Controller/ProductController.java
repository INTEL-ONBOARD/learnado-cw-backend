...
public class ProductController {
    ...
    // Get products with quantity greater than a specified value
    @GetMapping("/quantity/{minQty}")
    public List<Product> getProductsByQuantityGreaterThan(@PathVariable Integer minQty) {
